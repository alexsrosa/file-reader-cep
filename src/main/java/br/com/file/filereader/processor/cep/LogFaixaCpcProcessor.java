...
import br.com.file.filereader.converter.cep.LogFaixaCpcConverter;
 ...
 */
public class LogFaixaCpcProcessor implements Processor {

    private final static String fileIn = "LOG_FAIXA_CPC.txt";
    private final static String fileOut = "LOG_FAIXA_CPC.sql";
    private Processor processor;

    @Override
    public void process() {
        FileUtil fileUtil = new FileUtil();
        fileUtil.readAndWhite(fileIn, fileOut, new LogFaixaCpcConverter());
