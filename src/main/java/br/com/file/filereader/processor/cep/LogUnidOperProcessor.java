...
import br.com.file.filereader.converter.cep.LogUnidOperConverter;
 ...
 */
public class LogUnidOperProcessor implements Processor {

    private final static String fileIn = "LOG_UNID_OPER.txt";
    private final static String fileOut = "LOG_UNID_OPER.sql";
    private Processor processor;

    @Override
    public void process() {
        FileUtil fileUtil = new FileUtil();
        fileUtil.readAndWhite(fileIn, fileOut, new LogUnidOperConverter());
